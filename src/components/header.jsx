...
function Header() {
    ...
    const toggleLanguage = (event) => {  
        const newLanguage = event.target.checked ? 'french' : 'english';  
        setLanguage(newLanguage);  
        const newLocale = newLanguage === 'english' ? 'en' : 'fr';  
                    ...
                    <div className={styles.menuContainer}>  
                        ...
                        >  
                            <Box id={styles.menuContent}>
                                ...
                                <Link className={styles.link} href="https://black-bush-0a6b4b00f.4.azurestaticapps.net/"><Typography>{t('menu-main')}</Typography></Link>
                                <Link className={styles.link} href={t('link-home')}><Typography>{t('menu-home')}</Typography></Link>
                                <Link className={styles.link} href={t('link-fence')}><Typography>{t('menu-fence')}</Typography></Link>
                                <Link className={styles.link} href={t('link-scale')}><Typography>{t('menu-ageing')}</Typography></Link>
                                <Link className={styles.link} href={t('link-help')}><Typography>{t('menu-help')}</Typography></Link>
                            </Box> 
                        </Drawer>  
                    </div> 
