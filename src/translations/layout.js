...
export const en = {
    ...
    app: {
      title: "DFO OCDS and SDPA AI Hub"
    },
    userMenu: {
      profile: "Profile",
      account: "My account",
  ...
  export const fr = {
    ...
    app: {
      title: "Hub IA du MPO BIPD et PADS"
    },
    userMenu: {
      profile: "Profil",
      account: "Mon compte",
