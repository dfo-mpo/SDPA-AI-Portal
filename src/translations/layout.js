...
export const en = {
  ...
  export const fr = {
    ...
    app: {
      title: "Hub IA Éducatif BIPD du MPO"
    },
    userMenu: {
      profile: "Profil",
      account: "Mon compte",
