...
## Code Overview
The AI Hub is made up of 2 components:
...
The docker-compose.yml file will allow for a docker container be created using the frontend, chroma, and backend images. It reroutes the frontend exposure port to 3080 while rerouting the backend port to 8080.
